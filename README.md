...
新增包含 3 项赛事的竞赛 Pro 简读库和本地院校档案：简读会按本地专业资料匹配排序；目前不接真实支付，付费意愿、昵称、学校、专业和年级只保存在当前浏览器；自填学校始终显示“未认证”。
...
赛事日期数据位于 `data/events.js`，福大认定目录位于 `data/recognitions.js`。每条时间轴记录必须包含公开原文、核验日期和明确的时间节点；全国截止与校内截止不得混写，认定目录中的赛事不能在没有当届官方日期时进入时间轴。
